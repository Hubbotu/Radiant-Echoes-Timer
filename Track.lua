...
local L = {
    enUS = {
        TOTAL_BRONZE = "Total Memories: ",
        BRONZE_PER_HOUR = "Memories per hour: ",
        BRONZE_THIS_SESSION = "Memories this session: ",
        BRONZE_TRACKER = "Memories Tracker"
    },
    ruRU = {
        TOTAL_BRONZE = "Всего воспоминаний: ",
        BRONZE_PER_HOUR = "Воспоминаний в час: ",
        BRONZE_THIS_SESSION = "Воспоминаний за эту сессию: ",
        BRONZE_TRACKER = "Отслеживание Воспоминаний"
    },
    frFR = {
        TOTAL_BRONZE = "Résiduels total: ",
        BRONZE_PER_HOUR = "Résiduels par heure: ",
        BRONZE_THIS_SESSION = "Résiduels cette session: ",
        BRONZE_TRACKER = "Suivi de résiduels"
    },
	deDE = {
        TOTAL_BRONZE = "Erinnerungsreste: ",
        BRONZE_PER_HOUR = "Erinnerungsreste pro Stunde: ",
        BRONZE_THIS_SESSION = "Erinnerungsreste diese Sitzung: ",
        BRONZE_TRACKER = "Erinnerungsreste-Tracker"
    },
	esES = {
        TOTAL_BRONZE = "Total Memories: ",
        BRONZE_PER_HOUR = "Memories per hour: ",
...
local function Initialize()
    local currencyInfo = C_CurrencyInfo.GetCurrencyInfo(3089)
...
SLASH_MEMTRACKER1 = '/mem'
SlashCmdList["MEMTRACKER"] = ToggleBronzeTrackerFrame